...
public class TuringMachine {
	...
	public TuringMachine(String name, Set<Character> alphabet, Set<String> states, String initialState,
			Set<String> finalStates, Set<Character> auxAlphabet, char whiteChar, char initialchar,
	...
	public ProcessResult run(String tape, boolean silentMode) {
		...
		System.out.println(" ----- For the tape: "+tape+" ----- ");
		...
		while (!stop) {
			...
			if (isFinalState(state)) {
				if (silentMode) System.out.println(", this is the Final State! => ACEPTED\n");
			...
			if (silentMode && transition == null) System.out.println(" => REJECTED \n");
